# TITLE: FAIR Maturity Indicator MI-R1.3-7a4d616c66-IN_VV_METHODS_DOSE
...
### Maturity Indicator Identifier: [MI-R1.3-7a4d616c66-IN_VV_METHODS_DOSE](https://w3id.org/fair/maturity_indicator/terms/Gen2/MI-R1.3-7a4d616c66-IN_VV_METHODS_DOSE)
...
This MI is to indicate if the administered dose/concentration is reported by the nano toxicity study data or not.

### Maturity Indicator Name:  The administered dose/concentration is reported by the nano toxicity study
...
If the administered dose/concentration is reported by the nano toxicity study data or not.
...
The dose should be provided in a machine-readable format (JSON-LD) which can be queried using open universal protocol like HTTP.

### What is/are considered valid result(s)?
The presence of the field "dose" in the JSON-LD metadata means the measurement is reported which is the valid result.
