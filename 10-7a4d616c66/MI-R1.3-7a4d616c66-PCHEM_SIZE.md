# TITLE: FAIR Maturity Indicator MI-R1.3-7a4d616c66-PCHEM_SIZE
...
### Maturity Indicator Identifier: [MI-R1.3-7a4d616c66-PCHEM_SIZE](https://w3id.org/fair/maturity_indicator/terms/Gen2/MI-R1.3-7a4d616c66-PCHEM_SIZE)
...
This MI is to indicate if the nanomaterial's size is reported by the nano toxicity study data or not.
...
The physical dimensions of a particle: for spherical particles it is their diameter. For irregularly shaped particles it is the 
diameter of the equivalent sphere that has the same volume as a particle.
