# TITLE: FAIR Maturity Indicator MI-R1.3-7a4d616c66-PCHEM_CRYSTALLINITY
...
### Maturity Indicator Identifier: [MI-R1.3-7a4d616c66-PCHEM_CRYSTALLINITY](https://w3id.org/fair/maturity_indicator/terms/Gen2/MI-R1.3-7a4d616c66-PCHEM_CRYSTALLINITY)
...
This MI is to indicate if the nanomaterial's crystallinity is reported by the nano toxicity study data or not.

### Maturity Indicator Name:  The nanomaterial's crystallinity is reported by the nano toxicity study
...
If the nanomaterial's crystallinity is reported by the nano toxicity study data or not.
...
| ---------------- | -------------------------------- |
| crystallinity    | Crystallinity,<br>CRYSTALLINITY  |
