# TITLE: FAIR Maturity Indicator MI-R1.3-7a4d616c66-IN_VITRO_SUBJECT_MYCOPLASMA_TESTING
...
### Maturity Indicator Identifier: [MI-R1.3-7a4d616c66-IN_VITRO_SUBJECT_MYCOPLASMA_TESTING](https://w3id.org/fair/maturity_indicator/terms/Gen2/MI-R1.3-7a4d616c66-IN_VITRO_SUBJECT_MYCOPLASMA_TESTING)
...
### Maturity Indicator Name:  Mycoplasma testing is reported by the nano toxicity study
...
| ------------------- | ------------------------------------------ |
| mycoplasma testing  | mycoplasma_testing,<br>mycoplasma-testing  |
