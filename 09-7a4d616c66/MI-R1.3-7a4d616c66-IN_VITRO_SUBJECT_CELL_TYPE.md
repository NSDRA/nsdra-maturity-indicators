# TITLE: FAIR Maturity Indicator MI-R1.3-7a4d616c66-IN_VITRO_SUBJECT_CELL_TYPE
...
### Maturity Indicator Identifier: [MI-R1.3-7a4d616c66-IN_VITRO_SUBJECT_CELL_TYPE](https://w3id.org/fair/maturity_indicator/terms/Gen2/MI-R1.3-7a4d616c66-IN_VITRO_SUBJECT_CELL_TYPE)
...
This MI is to indicate if the cell type is reported by the nano toxicity study data or not.

### Maturity Indicator Name:  The cell type is reported by the nano toxicity study
...
If the cell type is reported by the nano toxicity study data or not.
...
| ----------- | ------------------------ |
| cell type   | cell_type,<br>cell-type  |

### How is the measurement executed?
The cell type should be provided in a machine-readable format (JSON-LD) which can be queried using open universal protocol like HTTP.

### What is/are considered valid result(s)?
The presence of the field "cell type" in the JSON-LD metadata means the measurement is reported which is the valid result.
