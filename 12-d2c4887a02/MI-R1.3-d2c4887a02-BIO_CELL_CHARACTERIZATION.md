# TITLE: FAIR Maturity Indicator MI-R1.3-d2c4887a02-BIO_CELL_CHARACTERIZATION
...
This MI is to indicate if the "cell characterization" is reported by the nano toxicity study data or not.

### Maturity Indicator Name:  The cell characterization is reported by the nano toxicity study
...
If the cell characterization is reported by the nano toxicity study data or not.
...
| ---------------------- | ------------------------------------------------ |
| cell characterization  | cell-characterization,<br>cell_characterization  |

### How is the measurement executed?
The "cell characterization" should be provided in a machine-readable format (JSON-LD) which can be queried using open universal protocol like HTTP.

### What is/are considered valid result(s)?
The presence of the field "cell characterization" in the JSON-LD metadata means the measurement is reported which is the valid result.
