# TITLE: FAIR Maturity Indicator MI-R1.3-d2c4887a02-BIO_MYCOPLASMA_TESTING
...
### Maturity Indicator Identifier: [MI-R1.3-d2c4887a02-BIO_MYCOPLASMA_TESTING](https://w3id.org/nsdra/maturity-indicator/readme/MI-R1.3-d2c4887a02-BIO_MYCOPLASMA_TESTING)
...
This MI is to indicate if the "mycoplasma testing" is reported by the nano toxicity study data or not.

### Maturity Indicator Name:  The cell mycoplasma testing is reported by the nano toxicity study
...
If the cell mycoplasma testing is reported by the nano toxicity study data or not.
...
| ------------------ | ----------------------------------------- |
| mycoplasma testing | mycoplasma-testing,<br>mycoplasma_testing |
