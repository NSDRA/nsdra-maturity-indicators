# TITLE: FAIR Maturity Indicator MI-R1.3-d2c4887a02-PROTOCOL_METHOD_OF_ADMINISTRATION
...
### Maturity Indicator Identifier: [MI-R1.3-d2c4887a02-PROTOCOL_METHOD_OF_ADMINISTRATION](https://w3id.org/nsdra/maturity-indicator/readme/MI-R1.3-d2c4887a02-PROTOCOL_METHOD_OF_ADMINISTRATION)
...
This MI is to indicate if the "method of administration" is reported by the nano toxicity study data or not.

### Maturity Indicator Name:  The method of administration is reported by the nano toxicity study
...
If the method of administration is reported by the nano toxicity study data or not.
...
The "method of administration" should be provided in a machine-readable format (JSON-LD) which can be queried using open universal protocol like HTTP.

### What is/are considered valid result(s)?
The presence of the field "method of administration" in the JSON-LD metadata means the measurement is reported which is the valid result.
