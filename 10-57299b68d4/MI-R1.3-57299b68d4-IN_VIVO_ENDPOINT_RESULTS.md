...
| ------------------------- | ----------------------------------------------- |
| endpoint results         | endpoint-results,<br>endpoint_results |
...
The presence of the field "endpoint results" in the JSON-LD metadata means the measurement is reported which is the valid result.
