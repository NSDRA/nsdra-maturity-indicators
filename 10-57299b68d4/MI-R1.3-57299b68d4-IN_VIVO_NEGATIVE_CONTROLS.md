# TITLE: FAIR Maturity Indicator MI-R1.3-57299b68d4-IN_VIVO_NEGATIVE_CONTROLS
...
### Maturity Indicator Identifier: [MI-R1.3-57299b68d4-IN_VIVO_NEGATIVE_CONTROLS](https://w3id.org/nsdra/maturity-indicator/readme/MI-R1.3-57299b68d4-IN_VIVO_NEGATIVE_CONTROLS)
...
| --------------------------- | --------------------------------------------------------- |
| negative controls in-vivo   | negative-controls-in-vivo,<br>negative_controls_in_vivo   |
...
The presence of the field "negative controls in-vivo" in the JSON-LD metadata means the measurement is reported which is the valid result.
 	...
 	"variableMeasured": [
 		{
 			...
 			"name": "negative controls in-vivo"
 		}
 	]
 }
```
