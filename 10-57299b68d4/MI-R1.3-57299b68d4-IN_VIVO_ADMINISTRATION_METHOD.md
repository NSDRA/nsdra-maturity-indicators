# TITLE: FAIR Maturity Indicator MI-R1.3-57299b68d4-IN_VIVO_ADMINISTRATION_METHOD
...
### Maturity Indicator Identifier: [MI-R1.3-57299b68d4-IN_VIVO_ADMINISTRATION_METHOD](https://w3id.org/nsdra/maturity-indicator/readme/MI-R1.3-57299b68d4-IN_VIVO_ADMINISTRATION_METHOD)
...
| ------------------------------ | ---------------------------------------------------------------- |
| administration method in-vivo  | administration-method-in-vivo,<br>administration_method_in_vivo  |
...
The presence of the field "administration method in-vivo" in the JSON-LD metadata means the measurement is reported which is the valid result.
 	...
 	"variableMeasured": [
 		{
 			...
 			"name": "administration method in-vivo"
 		}
 	]
 }
```
