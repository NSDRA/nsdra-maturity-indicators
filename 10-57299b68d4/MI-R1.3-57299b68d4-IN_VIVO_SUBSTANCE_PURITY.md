...
| ------------------------- | ------------------------------------------------ |
| test substance purity     | test-substance-purity,<br>test_substance_purity  |
...
The presence of the field "test substance purity" in the JSON-LD metadata means the measurement is reported which is the valid result.
