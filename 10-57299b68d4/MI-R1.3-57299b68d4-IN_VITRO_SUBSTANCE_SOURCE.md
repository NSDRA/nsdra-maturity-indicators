# TITLE: FAIR Maturity Indicator MI-R1.3-57299b68d4-IN_VITRO_SUBSTANCE_SOURCE
...
### Maturity Indicator Identifier: [MI-R1.3-57299b68d4-IN_VITRO_SUBSTANCE_SOURCE](https://w3id.org/nsdra/maturity-indicator/readme/MI-R1.3-57299b68d4-IN_VITRO_SUBSTANCE_SOURCE)
...
### Maturity Indicator Name:  The test substance source is reported by the nano toxicity study (in vitro)
...
The presence of the field "test substance source" in the JSON-LD metadata means the measurement is reported which is the valid result.
